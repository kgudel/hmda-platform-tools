...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r}function updateStatus(e){return{type:types.UPDATE_STATUS,status:e}}function checkErrors(e){var r=[];return e&&(0===e.size&&r.push("The file you uploaded does not contain any data. Please check your file and re-upload."),"txt"!==e.name.split(".").slice(-1)[0]&&r.push("The file you uploaded is not a text file (.txt). Please check your file and re-upload.")),r}function selectFile(e){return{type:types.SELECT_FILE,file:e,errors:checkErrors(e)}}function uploadStart(){return{type:types.UPLOAD_START}}function uploadComplete(e){return{type:types.UPLOAD_COMPLETE,xhrLoadEvent:e}}function uploadError(){return{type:types.UPLOAD_ERROR}}function requestIRS(){return{type:types.REQUEST_IRS}}function receiveIRS(e){return{type:types.RECEIVE_IRS,msas:e.msas}}function requestParseErrors(){return{type:types.REQUEST_PARSE_ERRORS}}function receiveParseErrors(e){return{type:types.RECEIVE_PARSE_ERRORS,transmittalSheetErrors:e.transmittalSheetErrors,larErrors:e.larErrors}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.updateStatus=updateStatus,exports.selectFile=selectFile,exports.uploadStart=uploadStart,exports.uploadComplete=uploadComplete,exports.uploadError=uploadError,exports.requestIRS=requestIRS,exports.receiveIRS=receiveIRS,exports.requestParseErrors=requestParseErrors,exports.receiveParseErrors=receiveParseErrors;var _api=require("../api"),_constants=require("../constants"),types=_interopRequireWildcard(_constants);
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.parseErrors=exports.status=exports.upload=exports.empty=void 0;var _extends=Object.assign||function(r){for(var t=1;t<arguments.length;t++){var e=arguments[t];for(var s in e)Object.prototype.hasOwnProperty.call(e,s)&&(r[s]=e[s])}return r},_redux=require("redux"),_constants=require("../constants"),defaultUpload={uploading:!1,file:null,errors:[]},defaultStatus={code:null,message:""},defaultParseErrors={isFetching:!1,transmittalSheetErrors:[],larErrors:[]},empty=exports.empty=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};arguments[1];return r},upload=exports.upload=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:defaultUpload,t=arguments[1];switch(t.type){case _constants.SELECT_FILE:return _extends({},r,{file:t.file,errors:t.errors});default:return r}},status=exports.status=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:defaultStatus,t=arguments[1];switch(t.type){case _constants.UPDATE_STATUS:return t.status;default:return r}},parseErrors=exports.parseErrors=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:defaultParseErrors,t=arguments[1];switch(t.type){case _constants.REQUEST_PARSE_ERRORS:return _extends({},r,{isFetching:!0});case _constants.RECEIVE_PARSE_ERRORS:return{isFetching:!1,transmittalSheetErrors:t.transmittalSheetErrors,larErrors:t.larErrors};default:return r}};exports.default=(0,_redux.combineReducers)({empty:empty,upload:upload,status:status,parseErrors:parseErrors});
